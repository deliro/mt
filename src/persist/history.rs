...
const SETTING_ALERTS: &str = "alerts";
...
impl HistoryStore {
    ...
    pub fn load_alerts_json(&self) -> Result<Option<String>, PersistError> {
        self.load_setting(SETTING_ALERTS)
    }

    pub fn save_alerts_json(&self, value: &str) -> Result<(), PersistError> {
        self.save_setting(SETTING_ALERTS, Some(value))
    }
